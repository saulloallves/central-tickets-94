...
export const FloatingOrbs: React.FC = () => {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      {/* Orb 1 */}
      <div 
        className="absolute w-[800px] h-[800px] rounded-full blur-3xl opacity-20 animate-float"
        style={{
      ...
      {/* Orb 2 */}
      <div 
        className="absolute w-[700px] h-[700px] rounded-full blur-3xl opacity-15 animate-float-delayed"
        style={{
