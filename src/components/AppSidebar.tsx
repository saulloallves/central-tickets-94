...
export function AppSidebar() {
  ...
  return (
    <div
      className={cn(
        "h-[calc(100vh-18rem)] fixed left-4 top-1/2 -translate-y-1/2 z-40 transition-all duration-250",
                  ...
                  <TooltipProvider delayDuration={0}>
                    <NavLink
                      ...
                      className={({ isActive }) => cn(
                        "group flex items-center px-3 py-2 rounded-xl transition-all duration-250",
                        "hover:scale-[1.02]",
                        isActive 
                      ...
                      {({ isActive }) => (
                        <>
                          <div className="relative flex items-center justify-center w-6 h-6 mr-2">
                            <item.icon 
                               className={cn(
                                 "h-4 w-4 text-white transition-all duration-250 drop-shadow-md",
                           ...
                           <span className={cn(
                             "text-white text-sm font-medium transition-all duration-250 drop-shadow-md",
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <NavLink
                          ...
                          className={({ isActive }) => cn(
                            "group relative flex items-center justify-center w-10 h-10 rounded-xl transition-all duration-250 mx-auto",
                            isActive 
            ...
            {isExpanded ? (
              <DropdownMenu modal={false}>
                <DropdownMenuTrigger asChild>
                  <Button 
                    variant="ghost" 
                    className="group w-full flex items-center justify-between px-3 py-2 text-white hover:bg-white/5 transition-all duration-250 rounded-xl"
                  >
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className="relative">
                      <Avatar className="h-8 w-8 mx-auto cursor-pointer hover:scale-[1.02] transition-all duration-250">
                        <AvatarImage src={user?.user_metadata?.avatar_url} />
                        <AvatarFallback className="bg-white/20 text-white text-xs">
                          {user?.email?.charAt(0).toUpperCase() || 'U'}
                        </AvatarFallback>
