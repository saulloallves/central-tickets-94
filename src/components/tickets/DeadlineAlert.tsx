  ...
  return (
    <Alert className="border-amber-500 bg-amber-50 dark:bg-amber-950/30 animate-in slide-in-from-top-2 duration-500 p-4 md:p-5">
      ...
      <AlertDescription className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 md:gap-4 ml-2">
        <span className="text-base md:text-lg font-bold text-amber-900 dark:text-amber-100 flex-1">
          ATENÇÃO: Todos os tickets precisam ser resolvidos até as 18h!
        </span>
        <div className="text-base md:text-lg text-amber-700 dark:text-amber-300 font-bold whitespace-nowrap">
