...
serve(async (req: Request) => {
  ...
  try {
    console.log("📚 AUTOATENDIMENTO_MANUAIS - Recebendo requisição");
    ...
    const payload = {
      phone,
      message: "📚 *Manuais de Franquia*\n\nTodos os manuais e documentação da franquia estão disponíveis em:\n\n🔗 https://crescieperdi.com.br/manuais\n\n📖 Você encontrará:\n• Manual do Franqueado\n• Guia de Operações\n• Protocolos de Atendimento\n• Material de Marketing",
    };

    const zapiUrl = `${baseUrl}/instances/${instanceId}/token/${instanceToken}/send-text`;
    console.log(`📤 Enviando manuais info para Z-API: ${zapiUrl.replace(instanceToken, '****')}`);
    ...
    console.log("📤 Manuais info enviado:", data);
