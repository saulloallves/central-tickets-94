...
serve(async (req: Request) => {
  ...
  try {
    ...
    const payload = {
      phone,
      message: "📚 *Manuais da Franquia*\n\nTodos os manuais estão aqui: https://sua-url.com/manuais",
    };
    ...
    return new Response(JSON.stringify({ success: true, step: "manuais" }), { headers: { "Content-Type": "application/json", ...corsHeaders }, status: 200 });
  } catch (err) {
