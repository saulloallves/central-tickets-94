...
serve(async (req: Request) => {
  ...
  try {
    ...
    const payload = {
      phone,
      message: "🗝️ Se você esqueceu sua senha, acesse: https://sua-url.com/senha",
    };
    ...
    return new Response(JSON.stringify({ success: true, step: "senha" }), { headers: { "Content-Type": "application/json", ...corsHeaders }, status: 200 });
  } catch (err) {
