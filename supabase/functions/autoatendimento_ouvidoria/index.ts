...
serve(async (req: Request) => {
  ...
  try {
    ...
    const payload = {
      phone,
      message: "📢 Para registrar uma manifestação na Ouvidoria, use este link: https://sua-url.com/ouvidoria",
    };
    ...
    return new Response(JSON.stringify({ success: true, step: "ouvidoria" }), { headers: { "Content-Type": "application/json", ...corsHeaders }, status: 200 });
  } catch (err) {
