-- Atualizar enum de prioridades para usar baixo, medio, alto, imediato
...
-- Atualizar tabela tickets com mapeamento das prioridades antigas para novas
ALTER TABLE tickets 
...
-- Atualizar função de trigger para usar novas prioridades
