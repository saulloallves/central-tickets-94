-- Corrigir função para não enviar notificações de SLA se ticket já está concluído
...
begin
  -- Não enviar notificações de SLA se ticket já está concluído
  ...
  -- Detectar ticket encaminhado para equipe
