...
-- 3. Criar a tabela principal - usando text-embedding-3-small (1536 dimensões) para compatibilidade com índices
CREATE TABLE documentos (
    ...
    embedding VECTOR(1536) -- text-embedding-3-small para compatibilidade com índices
);
