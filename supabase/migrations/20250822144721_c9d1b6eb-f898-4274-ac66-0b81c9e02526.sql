-- Corrigir prioridades removendo TODAS as views dependentes

-- 1. Remover todas as views que dependem da coluna prioridade
DROP VIEW IF EXISTS v_tickets_metrics CASCADE;
DROP VIEW IF EXISTS v_team_performance CASCADE;
DROP VIEW IF EXISTS v_unit_metrics CASCADE;
