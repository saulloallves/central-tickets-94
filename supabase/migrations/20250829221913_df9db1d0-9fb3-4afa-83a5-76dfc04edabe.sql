...
-- 5. Criar o índice vetorial IVFFlat para buscas por similaridade (suporta +2000 dimensões)
CREATE INDEX idx_documentos_embedding ON documentos USING ivfflat (embedding vector_l2_ops) WITH (lists = 100);
