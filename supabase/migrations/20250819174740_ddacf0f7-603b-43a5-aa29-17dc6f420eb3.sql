...
-- Gerente (keeping existing role)
('gerente', 'view_team_tickets'),
('gerente', 'view_own_unit_tickets'),
('gerente', 'respond_tickets'),
('gerente', 'escalate_tickets'),
('gerente', 'access_dashboards'),
('gerente', 'manage_knowledge_base'),
('gerente', 'validate_ai_content'),
('gerente', 'export_reports'),
('gerente', 'view_all_history'),
('gerente', 'validate_ai_responses'),

-- Diretor (keeping existing role)
('diretor', 'view_all_tickets'),
('diretor', 'view_own_unit_tickets'),
('diretor', 'view_team_tickets'),
('diretor', 'respond_tickets'),
('diretor', 'escalate_tickets'),
('diretor', 'access_dashboards'),
('diretor', 'manage_knowledge_base'),
('diretor', 'validate_ai_content'),
('diretor', 'view_audit_logs'),
('diretor', 'export_reports'),
('diretor', 'view_all_history'),
('diretor', 'manage_crisis'),
('diretor', 'supervise_units'),

-- Colaborador (keeping existing role)
