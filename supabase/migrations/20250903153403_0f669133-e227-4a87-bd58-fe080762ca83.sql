-- Corrigir detecção de crises múltiplas para o mesmo problema
-- Melhorar o algoritmo de matching para agrupar problemas similares corretamente
...
BEGIN
    ...
    IF array_length(problem_keywords, 1) IS NULL THEN
        ...
        -- Limitar a 3 palavras mais relevantes
    ...
    IF max_overlap >= 1 THEN
        ...
        -- Update keywords to include new ones
        UPDATE crises 
        SET palavras_chave = array(
            SELECT DISTINCT unnest(palavras_chave || problem_keywords)
        ),
