...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_tickets_status_updated_at 
ON public.tickets (status, updated_at DESC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_tickets_unidade_status 
ON public.tickets (unidade_id, status);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_tickets_equipe_status 
