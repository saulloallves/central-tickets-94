-- Create missing get_user_permissions function and fix the problematic string interpolation in get_unit_metrics
...
BEGIN
    ...
    WITH unit_data AS (
        ...
        WHERE t.data_abertura >= (CURRENT_DATE - (p_periodo_dias || ' days')::INTERVAL)
